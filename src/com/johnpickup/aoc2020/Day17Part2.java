...
public class Day17Part2 {
    ...
    public static void main(String[] args) {
        ...
        String prefix = "/Volumes/User Data/john/Development/AdventOfCode/resources/2020/Day17/Day17";
...
//                    System.out.println(conwayGrid);
    ...
    static class ConwayGrid {
        ...
        ConwayGrid(List<String> lines) {
            ...
            occupied = gridZ0.findAll('#').stream().map(c2 -> new Coord4D(c2.getX(), c2.getY(), 0, 0)).collect(Collectors.toSet());
        }
