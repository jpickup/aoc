...
public class Day23Amphipod {
    public static void main(String[] args) {
        Day23Amphipod day23 = new Day23Amphipod();
        Board initial = testBoard();
        Set<Board> solutions = day23.solve(initial, Collections.emptyList());
        System.out.println(solutions);
    }

    private Set<Board> solve(Board board, List<Board> knownBoards) {
        System.out.println(board + "  --- " + knownBoards.size()) ;
        if (board.solved()) return Collections.singleton(board);

        List<Board> moreKnownBoards = new ArrayList<>(knownBoards);
        moreKnownBoards.add(board);

        Set<Move> possibleMoves = board.getPossibleMoves();
        return possibleMoves.stream()
                .map(board::applyMove)
                .filter(b -> knownBoards.stream().noneMatch(kb -> kb.sameAmphipods(b)))
                .flatMap(b -> solve(b, moreKnownBoards).stream())
  ...
  15 16 17 18
    ...
    static class Board {
        ...
        static {
            ...
            validMoves.add(new Move(15, 0, 4, "ABCD", Arrays.asList(1,11)));
            validMoves.add(new Move(15, 1, 3, "ABCD", Arrays.asList(11)));
            validMoves.add(new Move(15, 3, 3, "ABCD", Arrays.asList(11)));
            validMoves.add(new Move(15, 5, 5, "ABCD", Arrays.asList(3,11)));
            validMoves.add(new Move(15, 7, 7, "ABCD", Arrays.asList(3,5,11)));
            validMoves.add(new Move(15, 9, 9, "ABCD", Arrays.asList(3,5,7,11)));
            validMoves.add(new Move(15, 10, 10, "ABCD", Arrays.asList(3,5,7,8,11)));
            ...
            validMoves.add(new Move(16, 0, 6, "ABCD", Arrays.asList(12,1,3)));
            validMoves.add(new Move(16, 1, 5, "ABCD", Arrays.asList(12,3)));
            validMoves.add(new Move(16, 3, 3, "ABCD", Arrays.asList(12)));
            validMoves.add(new Move(16, 5, 3, "ABCD", Arrays.asList(12)));
            validMoves.add(new Move(16, 7, 5, "ABCD", Arrays.asList(12,5)));
            validMoves.add(new Move(16, 9, 7, "ABCD", Arrays.asList(12,5,7)));
            validMoves.add(new Move(16, 10, 8, "ABCD", Arrays.asList(12,5,7,8)));
            ...
            validMoves.add(new Move(17, 0, 8, "ABCD", Arrays.asList(13,1,3,5)));
            validMoves.add(new Move(17, 1, 7, "ABCD", Arrays.asList(13,3,5)));
            validMoves.add(new Move(17, 3, 5, "ABCD", Arrays.asList(13,5)));
            validMoves.add(new Move(17, 5, 4, "ABCD", Arrays.asList(13)));
            validMoves.add(new Move(17, 7, 4, "ABCD", Arrays.asList(13)));
            validMoves.add(new Move(17, 9, 5, "ABCD", Arrays.asList(13,7)));
            validMoves.add(new Move(17, 10, 6, "ABCD", Arrays.asList(13,7,8)));
            ...
            validMoves.add(new Move(18, 0, 10, "ABCD", Arrays.asList(14,1,3,5,7)));
            validMoves.add(new Move(18, 1, 9, "ABCD", Arrays.asList(14,3,5,7)));
            validMoves.add(new Move(18, 3, 7, "ABCD", Arrays.asList(14,5,7)));
            validMoves.add(new Move(18, 5, 5, "ABCD", Arrays.asList(14,7)));
            validMoves.add(new Move(18, 7, 3, "ABCD", Arrays.asList(14)));
            validMoves.add(new Move(18, 9, 3, "ABCD", Arrays.asList(14)));
            validMoves.add(new Move(18, 10, 4, "ABCD", Arrays.asList(14,8)));
        ...
        public Board applyMove(Move move) {
            ...
            return new Board(newPositions, totalEnergy + stepEnergy.get(moved));
        }
        ...
        public boolean equals(Object o) {
            ...
            Board board = (Board) o;
            return totalEnergy == board.totalEnergy &&
                    Objects.equals(amphipods, board.amphipods);
        }
